...
class="lazyload" />
 -->
 <!-- <a href="bhbu"><img alt="Stivaletti" src="../assets/images/github-unicorn.placeholder.jpg"></a> -->

![unicornsimage]({{ "/assets/images/github-unicorn.jpg" | absolute_url }}){: .center-image}
